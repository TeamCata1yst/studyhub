  ...
  return loading ? (
    ...
    <>
      ...
      <div className="space-y-4 p-4">
        <h2 className="font-semibold pb-1">Bio</h2>
        <p className="text-sm">{bio}</p>
        <hr />
        <h2 className="font-semibold pb-1">URLs</h2>
        <div className="text-sm flex flex-col gap-2">
          {urls.map((u, i) => (
            <Link key={i} href={u} className="text-sm font-medium underline">
              {u.includes("instagram.com") ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="h-4 w-4 inline mr-2 dark:invert"
                >
        ...
        <hr />
        <h2 className="font-semibold pb-1">Interests</h2>
